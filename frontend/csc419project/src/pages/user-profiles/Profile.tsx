  ...
  return (
    <div className="w-full">
          ...
          <div className="pt-20 md:pt-24 mb-6">
            ...
            <div className="hidden md:flex flex-row justify-between items-center gap-4">
              ...
              <div className="flex flex-col shrink-0">
                ...
                <p className="text-gray-500 text-sm font-medium mt-1">@nimitimi</p>
              </div>
              ...
              <div className="flex items-center gap-10">
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-white transition-colors group">
                  ...
                  <span className="text-gray-500 text-base group-hover:text-gray-300">Following</span>
                </div>
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-white transition-colors group">
                  <span className="font-bold text-white text-xl">12</span>
                  <span className="text-gray-500 text-base group-hover:text-gray-300">Followers</span>
                </div>
                <div className="flex items-center gap-1.5 cursor-pointer hover:text-white transition-colors group">
                  <span className="font-bold text-white text-xl">48</span>
                  <span className="text-gray-500 text-base group-hover:text-gray-300">Friends</span>
                </div>
              </div>

               {/* Button */}
              <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2.5 px-8 rounded-lg transition-colors text-sm shadow-lg shadow-orange-500/20 shrink-0">
                New Post
              </button>
            </div>
            ...
            <div className="flex flex-col md:hidden gap-4">
              ...
              <div className="flex justify-between items-start">
                 <div className="flex flex-col shrink-0">
                    ...
                    <p className="text-gray-500 text-sm font-medium mt-0.5">@nimitimi</p>
                  </div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-1 cursor-pointer hover:text-white transition-colors group">
                  ...
                  <span className="text-gray-500 text-sm group-hover:text-gray-300">Following</span>
                </div>
                <div className="flex items-center gap-1 cursor-pointer hover:text-white transition-colors group">
                  <span className="font-bold text-white text-lg">12</span>
                  <span className="text-gray-500 text-sm group-hover:text-gray-300">Followers</span>
                </div>
                <div className="flex items-center gap-1 cursor-pointer hover:text-white transition-colors group">
                  <span className="font-bold text-white text-lg">48</span>
                  <span className="text-gray-500 text-sm group-hover:text-gray-300">Friends</span>
                </div>
              </div>
      ...
      <div className="px-2 md:px-4">
        {POSTS.map((post) => (
          <div key={post.id} className="py-6 border-b border-gray-800 flex gap-4">
            {/* Post Avatar */}
            ...
            <div className="flex-1">
              ...
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-bold text-sm text-gray-100">{post.name}</span>
                {post.subtext && (
