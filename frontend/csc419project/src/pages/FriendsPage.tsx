...
export default function FriendsPage() {
  ...
  return (
    ...
    */
    <main className="flex-1 bg-[#1A1A1A] py-8 px-4 overflow-y-auto flex justify-center">
      ...
      */}
      <div className="w-full max-w-3xl flex flex-col">
        ...
        <div className="flex gap-3 mb-10 overflow-x-auto w-full justify-center no-scrollbar">
          {categories.map((cat) => (
            <button
              key={cat}
